...
public class GetInvitations extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		PartecipantsDAO partecipantDAO = new PartecipantsDAO(connection);
		List<Meeting> hisInvitations;
		try {
			hisInvitations = partecipantDAO.FindMeetingInvitation(currentUser.getUsername());
		}catch(SQLException e) {
		...
		String json = new Gson().toJson(hisInvitations);
